...
class sdShop
{
	static init_class()
	{
		...
		sdShop.options.push({ _class: 'sdGun', class: sdGun.CLASS_CUBE_SPEAR, filter: 'hue-rotate(180deg) saturate(2)', _category:'root', _opens_category:'Equipment' });
		...
		sdShop.options.push({ _class: 'sdGun', class: sdGun.CLASS_ADMIN_TELEPORTER, _category:'root', _godmode_only: true, _opens_category:'Admin tools' }); // Cost of Infinity is what actually prevents items here from being accessible to non-in-godmode-admins
		...
		sdShop.options.push({ _class: 'sdHover', filter: 'saturate(2)', _category:'Vehicles' });
		...
		sdShop.options.push({ _class: 'sdHover', filter: 'saturate(10)', _category:'Vehicles', _min_workbench_level: 2 });
		sdShop.options.push({ _class: 'sdHover', filter: 'hue-rotate(90deg) saturate(10)', _category:'Vehicles', _min_workbench_level: 2 });
		sdShop.options.push({ _class: 'sdHover', filter: 'hue-rotate(180deg) saturate(10)', _category:'Vehicles', _min_workbench_level: 2 });
		sdShop.options.push({ _class: 'sdHover', filter: 'hue-rotate(270deg) saturate(10)', _category:'Vehicles', _min_workbench_level: 2 });
		sdShop.options.push({ _class: 'sdHover', filter: 'saturate(0) brightness(1.5)', _category:'Vehicles', _min_workbench_level: 3 });
		sdShop.options.push({ _class: 'sdHover', filter: 'saturate(0) brightness(0.5)', _category:'Vehicles', _min_workbench_level: 3 });
		sdShop.options.push({ _class: 'sdHover', filter: 'saturate(0) brightness(2)', _category:'Vehicles', _min_workbench_level: 3 });
		sdShop.options.push({ _class: 'sdHover', filter: 'saturate(0) brightness(0.25)', _category:'Vehicles', _min_workbench_level: 3 });
		sdShop.options.push({ _class: 'sdHover', filter: 'saturate(2)', type: 1, _category:'Vehicles', _min_build_tool_level: 17 });
		...
		sdShop.options.push({ _class: 'sdHover', type: 1, filter: 'saturate(10)', _category:'Vehicles', _min_build_tool_level: 17, _min_workbench_level: 2 });
		sdShop.options.push({ _class: 'sdHover', type: 1, filter: 'hue-rotate(90deg) saturate(10)', _category:'Vehicles', _min_build_tool_level: 17, _min_workbench_level: 2 });
		sdShop.options.push({ _class: 'sdHover', type: 1, filter: 'hue-rotate(180deg) saturate(10)', _category:'Vehicles', _min_build_tool_level: 17, _min_workbench_level: 2 });
		sdShop.options.push({ _class: 'sdHover', type: 1, filter: 'hue-rotate(270deg) saturate(10)', _category:'Vehicles', _min_build_tool_level: 17, _min_workbench_level: 2 });
		sdShop.options.push({ _class: 'sdHover', type: 1, filter: 'saturate(0) brightness(1.5)', _category:'Vehicles', _min_build_tool_level: 17, _min_workbench_level: 3 });
		sdShop.options.push({ _class: 'sdHover', type: 1, filter: 'saturate(0) brightness(0.5)', _category:'Vehicles', _min_build_tool_level: 17, _min_workbench_level: 3 });
		sdShop.options.push({ _class: 'sdHover', type: 1, filter: 'saturate(0) brightness(2)', _category:'Vehicles', _min_build_tool_level: 17, _min_workbench_level: 3 });
		sdShop.options.push({ _class: 'sdHover', type: 1, filter: 'saturate(0) brightness(0.25)', _category:'Vehicles', _min_build_tool_level: 17, _min_workbench_level: 3 });
		sdShop.options.push({ _class: 'sdHover', type: 2, filter: 'saturate(2)', _category:'Vehicles', _min_build_tool_level: 24 });
		...
		sdShop.options.push({ _class: 'sdHover', type: 2, filter: 'saturate(10)', _category:'Vehicles', _min_build_tool_level: 24, _min_workbench_level: 2 });
		sdShop.options.push({ _class: 'sdHover', type: 2, filter: 'hue-rotate(90deg) saturate(10)', _category:'Vehicles', _min_build_tool_level: 24, _min_workbench_level: 2 });
		sdShop.options.push({ _class: 'sdHover', type: 2, filter: 'hue-rotate(180deg) saturate(10)', _category:'Vehicles', _min_build_tool_level: 24, _min_workbench_level: 2 });
		sdShop.options.push({ _class: 'sdHover', type: 2, filter: 'hue-rotate(270deg) saturate(10)', _category:'Vehicles', _min_build_tool_level: 24, _min_workbench_level: 2 });
		sdShop.options.push({ _class: 'sdHover', type: 2, filter: 'saturate(0) brightness(1.5)', _category:'Vehicles', _min_build_tool_level: 24, _min_workbench_level: 3 });
		sdShop.options.push({ _class: 'sdHover', type: 2, filter: 'saturate(0) brightness(0.5)', _category:'Vehicles', _min_build_tool_level: 24, _min_workbench_level: 3 });
		sdShop.options.push({ _class: 'sdHover', type: 2, filter: 'saturate(0) brightness(2)', _category:'Vehicles', _min_build_tool_level: 24, _min_workbench_level: 3 });
		sdShop.options.push({ _class: 'sdHover', type: 2, filter: 'saturate(0) brightness(0.25)', _category:'Vehicles', _min_build_tool_level: 24, _min_workbench_level: 3 });
		...
		sdShop.options.push({ _class: 'sdQuadro', filter: 'saturate(0) brightness(2)', _category:'Vehicles', _min_workbench_level: 1 });
		sdShop.options.push({ _class: 'sdQuadro', filter: 'saturate(0) brightness(0.25)', _category:'Vehicles', _min_workbench_level: 1 });
		sdShop.options.push({ _class: 'sdHover', type: 3, _category:'Vehicles' });
		...
		sdShop.options.push({ _class: 'sdHover', type: 3, filter: 'saturate(0) brightness(2)', _category:'Vehicles', _min_workbench_level: 1 });
		sdShop.options.push({ _class: 'sdHover', type: 3, filter: 'saturate(0) brightness(0.25)', _category:'Vehicles', _min_workbench_level: 1 });
		sdShop.options.push({ _class: 'sdHoverBike', _category:'Vehicles', _min_build_tool_level: 44, _min_workbench_level: 28 });
		sdShop.options.push({ _class: 'sdHoverBike', filter: 'hue-rotate(300deg)', _category:'Vehicles', _min_build_tool_level: 44, _min_workbench_level: 28 });
		sdShop.options.push({ _class: 'sdHoverBike', filter: 'hue-rotate(270deg)', _category:'Vehicles', _min_build_tool_level: 44, _min_workbench_level: 28 });
		sdShop.options.push({ _class: 'sdHoverBike', filter: 'hue-rotate(210deg)', _category:'Vehicles', _min_build_tool_level: 44, _min_workbench_level: 28 });
		sdShop.options.push({ _class: 'sdHoverBike', filter: 'hue-rotate(140deg)', _category:'Vehicles', _min_build_tool_level: 44, _min_workbench_level: 28 });
		sdShop.options.push({ _class: 'sdHoverBike', filter: 'saturate(0) brightness(1.5)', _category:'Vehicles', _min_build_tool_level: 44, _min_workbench_level: 27 });
		sdShop.options.push({ _class: 'sdHoverBike', filter: 'saturate(0) brightness(0.5)', _category:'Vehicles', _min_build_tool_level: 44, _min_workbench_level: 27 });
		sdShop.options.push({ _class: 'sdHoverBike', filter: 'saturate(0) brightness(2)', _category:'Vehicles', _min_build_tool_level: 44, _min_workbench_level: 29 });
		sdShop.options.push({ _class: 'sdHoverBike', filter: 'saturate(0) brightness(0.25)', _category:'Vehicles', _min_build_tool_level: 44, _min_workbench_level: 29 });
		...
		for ( var i = 0; i < 20; i++ )
		{
			...
			sdShop.options.push({ _class: 'sdDoor', width: 32, height: 32, filter: filter, _category:'Doors', open_type: 1, _min_build_tool_level: 31, _min_workbench_level: 11 });
			sdShop.options.push({ _class: 'sdDoor', width: 32, height: 32, filter: filter, model: sdDoor.MODEL_ARMORED, _reinforced_level: 1, _category:'Doors', _min_build_tool_level: 37, open_type: 1, _min_workbench_level: 13 });
			sdShop.options.push({ _class: 'sdDoor', width: 32, height: 32, filter: filter, model: sdDoor.MODEL_ARMORED_LVL2, _reinforced_level: 2, _category:'Doors', _min_build_tool_level: 46, open_type: 1, _min_workbench_level: 15 });
		}
		...
		sdShop.options.push({ _class: 'sdCom', variation: 8, _category:'Base equipment', _min_build_tool_level:16 });
		sdShop.options.push({ _class: 'sdCom', variation: 9, _category:'Base equipment', _min_build_tool_level:18 });
		sdShop.options.push({ _class: 'sdCom', variation: 10, _category:'Base equipment', _min_build_tool_level:30, _min_workbench_level: 13 });
		sdShop.options.push({ _class: 'sdCom', variation: 11, _category:'Base equipment', _min_build_tool_level:32, _min_workbench_level: 14 });
		...
		sdShop.options.push({ _class: 'sdStorage', filter: 'saturate(10)', _category:'Base equipment', _min_workbench_level: 3 });
		sdShop.options.push({ _class: 'sdStorage', filter: 'hue-rotate(205deg) saturate(20)', _category:'Base equipment', _min_workbench_level: 3 });
		sdShop.options.push({ _class: 'sdStorage', filter: 'hue-rotate(220deg) saturate(10)', _category:'Base equipment', _min_workbench_level: 3 });
		sdShop.options.push({ _class: 'sdStorage', filter: 'hue-rotate(135deg) saturate(10)', _category:'Base equipment', _min_workbench_level: 3 });
		...
		sdShop.options.push({ _class: 'sdStorage', type: 1, filter: 'saturate(10)', _category:'Base equipment', _min_build_tool_level: 1, _min_workbench_level: 4 });
		sdShop.options.push({ _class: 'sdStorage', type: 1, filter: 'hue-rotate(205deg) saturate(20)', _category:'Base equipment', _min_build_tool_level: 1, _min_workbench_level: 4 });
		sdShop.options.push({ _class: 'sdStorage', type: 1, filter: 'hue-rotate(220deg) saturate(10)', _category:'Base equipment', _min_build_tool_level: 1, _min_workbench_level: 4 });
		sdShop.options.push({ _class: 'sdStorage', type: 1, filter: 'hue-rotate(135deg) saturate(10)', _category:'Base equipment', _min_build_tool_level: 1, _min_workbench_level: 4 });
		...
		sdShop.options.push({ _class: 'sdStorage', type: 2, filter: 'saturate(10)', _category:'Base equipment', _min_workbench_level: 3 });
		sdShop.options.push({ _class: 'sdStorage', type: 2, filter: 'hue-rotate(205deg) saturate(20)', _category:'Base equipment', _min_workbench_level: 3 });
		sdShop.options.push({ _class: 'sdStorage', type: 2, filter: 'hue-rotate(220deg) saturate(10)', _category:'Base equipment', _min_workbench_level: 3 });
		sdShop.options.push({ _class: 'sdStorage', type: 2, filter: 'hue-rotate(135deg) saturate(10)', _category:'Base equipment', _min_workbench_level: 3 });
		...
		sdShop.options.push({ _class: 'sdStorage', type: 3, filter: 'saturate(10)', _category:'Base equipment', _min_build_tool_level: 2, _min_workbench_level: 5 });
		sdShop.options.push({ _class: 'sdStorage', type: 3, filter: 'hue-rotate(205deg) saturate(20)', _category:'Base equipment', _min_build_tool_level: 2, _min_workbench_level: 5 });
		sdShop.options.push({ _class: 'sdStorage', type: 3, filter: 'hue-rotate(220deg) saturate(10)', _category:'Base equipment', _min_build_tool_level: 2, _min_workbench_level: 5 });
		sdShop.options.push({ _class: 'sdStorage', type: 3, filter: 'hue-rotate(135deg) saturate(10)', _category:'Base equipment', _min_build_tool_level: 2, _min_workbench_level: 5 });
		...
		sdShop.options.push({ _class: 'sdTurret', kind:sdTurret.KIND_LASER, _category:'Base equipment', type: 1, _min_build_tool_level: 31, _min_workbench_level: 22 });
		sdShop.options.push({ _class: 'sdTurret', kind:sdTurret.KIND_ROCKET, _category:'Base equipment', type: 1, _min_build_tool_level: 31, _min_workbench_level: 24 });
		sdShop.options.push({ _class: 'sdTurret', kind:sdTurret.KIND_RAPID_LASER, _category:'Base equipment', type: 1, _min_build_tool_level: 36, _min_workbench_level: 26 });
		sdShop.options.push({ _class: 'sdTurret', kind:sdTurret.KIND_SNIPER, _category:'Base equipment', type: 1, _min_build_tool_level: 43, _min_workbench_level: 28 });
		sdShop.options.push({ _class: 'sdTurret', kind:sdTurret.KIND_FREEZER, _category:'Base equipment', type: 1, _min_build_tool_level: 45, _min_workbench_level: 30 });
		...
		sdShop.options.push({ _class: 'sdMatterContainer', matter_max:640 * 2 * 2 * 2, _category:'Base equipment', _min_build_tool_level: 43 });
		sdShop.options.push({ _class: 'sdMatterContainer', matter_max:640 * 4 * 2 * 2, _category:'Base equipment', _min_build_tool_level: 46, _min_workbench_level: 10 });
		sdShop.options.push({ _class: 'sdMatterContainer', matter_max:640 * 8 * 2 * 2, _category:'Base equipment', _min_build_tool_level: 49, _min_workbench_level: 20 });
		sdShop.options.push({ _class: 'sdMatterContainer', matter_max:640 * 8 * 4 * 2, _category:'Base equipment', _min_build_tool_level: 52, _min_workbench_level: 30 });
		...
		sdShop.options.push({ _class: 'sdMatterAmplifier', multiplier: 16, _category:'Base equipment', _min_build_tool_level: 24 });
		...
		sdShop.options.push({ _class: 'sdRescueTeleport', _category:'Base equipment', _min_build_tool_level: 5 });
		...
		sdShop.options.push({ _class: 'sdThruster', filter: 'saturate(2)', _category:'Base equipment', _min_build_tool_level: 2 });
		...
		sdShop.options.push({ _class: 'sdThruster', filter: 'saturate(4)', _category:'Base equipment', _min_build_tool_level: 2, _min_workbench_level: 1 });
		sdShop.options.push({ _class: 'sdThruster', filter: 'hue-rotate(90deg) saturate(4)', _category:'Base equipment', _min_build_tool_level: 2, _min_workbench_level: 1 });
		sdShop.options.push({ _class: 'sdThruster', filter: 'hue-rotate(180deg) saturate(4)', _category:'Base equipment', _min_build_tool_level: 2, _min_workbench_level: 1 });
		sdShop.options.push({ _class: 'sdThruster', filter: 'hue-rotate(270deg) saturate(4)', _category:'Base equipment', _min_build_tool_level: 2, _min_workbench_level: 1 });
		...
		sdShop.options.push({ _class: 'sdUpgradeStation', _category:'Base equipment', _min_build_tool_level: 60, _min_workbench_level: 31 });
		sdShop.options.push({ _class: 'sdWorkbench', type: 1, _category:'Base equipment', _min_build_tool_level: 11 });
		sdShop.options.push({ _class: 'sdWorkbench', type: 2, _category:'Base equipment', _min_build_tool_level: 22, _min_workbench_level: 7 });
		sdShop.options.push({ _class: 'sdWorkbench', type: 3, _category:'Base equipment', _min_build_tool_level: 33, _min_workbench_level: 13 });
		sdShop.options.push({ _class: 'sdWorkbench', type: 4, _category:'Base equipment', _min_build_tool_level: 44, _min_workbench_level: 19 });
		sdShop.options.push({ _class: 'sdWorkbench', type: 5, _category:'Base equipment', _min_build_tool_level: 55, _min_workbench_level: 25 });
		...
		sdShop.options.push({ _class: 'sdFactionSpawner', type: 10, _category:'Base equipment', _min_build_tool_level: 52, _min_workbench_level: 29 });
		sdShop.options.push({ _class: 'sdFactionSpawner', type: 9, _category:'Base equipment', _min_build_tool_level: 60, _min_workbench_level: 31 });
		sdShop.options.push({ _class: 'sdFactionSpawner', type: 1, _category:'Other', _min_build_tool_level: 60, _min_workbench_level: 26 });
		sdShop.options.push({ _class: 'sdFactionSpawner', type: 2, _category:'Other', _min_build_tool_level: 60, _min_workbench_level: 31 });
		sdShop.options.push({ _class: 'sdFactionSpawner', type: 4, _category:'Other', _min_build_tool_level: 60, _min_workbench_level: 30 });
		sdShop.options.push({ _class: 'sdFactionSpawner', type: 5, _category:'Other', _min_build_tool_level: 60, _min_workbench_level: 29 });
		sdShop.options.push({ _class: 'sdFactionSpawner', type: 7, _category:'Other', _min_build_tool_level: 60, _min_workbench_level: 28 });
		sdShop.options.push({ _class: 'sdFactionSpawner', type: 8, _category:'Other', _min_build_tool_level: 60, _min_workbench_level: 27 });
		sdShop.options.push({ _class: 'sdCrystal', matter_max: 40, type:sdCrystal.TYPE_CRYSTAL_ARTIFICIAL, _category:'Other', _min_build_tool_level: 25, _min_workbench_level: 7 });
		sdShop.options.push({ _class: 'sdCrystal', matter_max: 80, type:sdCrystal.TYPE_CRYSTAL_ARTIFICIAL, _category:'Other', _min_build_tool_level: 30, _min_workbench_level: 10 });
		sdShop.options.push({ _class: 'sdCrystal', matter_max: 160, type:sdCrystal.TYPE_CRYSTAL_ARTIFICIAL, _category:'Other', _min_build_tool_level: 35, _min_workbench_level: 13 });
		sdShop.options.push({ _class: 'sdCrystal', matter_max: 320, type:sdCrystal.TYPE_CRYSTAL_ARTIFICIAL, _category:'Other', _min_build_tool_level: 40, _min_workbench_level: 16 });
		sdShop.options.push({ _class: 'sdCrystal', matter_max: 640, type:sdCrystal.TYPE_CRYSTAL_ARTIFICIAL, _category:'Other', _min_build_tool_level: 45, _min_workbench_level: 19 });
		sdShop.options.push({ _class: 'sdCrystal', matter_max: 1280, type:sdCrystal.TYPE_CRYSTAL_ARTIFICIAL, _category:'Other', _min_build_tool_level: 50, _min_workbench_level: 22 });
		sdShop.options.push({ _class: 'sdCrystal', matter_max: 2560, type:sdCrystal.TYPE_CRYSTAL_ARTIFICIAL, _category:'Other', _min_build_tool_level: 55, _min_workbench_level: 25 });
		sdShop.options.push({ _class: 'sdCrystal', matter_max: 5120, type:sdCrystal.TYPE_CRYSTAL_ARTIFICIAL, _category:'Other', _min_build_tool_level: 60, _min_workbench_level: 28 });
		sdShop.options.push({ _class: 'sdCrystal', matter_max: 5120 * 2, type:sdCrystal.TYPE_CRYSTAL_ARTIFICIAL, _category:'Other', _min_build_tool_level: 60, _min_workbench_level: 31 });
		sdShop.options.push({ _class: 'sdJunk', type: 0, _category:'Other', _min_build_tool_level: 24, _min_workbench_level: 16 });
		sdShop.options.push({ _class: 'sdJunk', type: 1, _category:'Other', _min_build_tool_level: 26, _min_workbench_level: 21 });
		sdShop.options.push({ _class: 'sdJunk', type: 7, _category:'Other', _min_build_tool_level: 38, _min_workbench_level: 26 });
		sdShop.options.push({ _class: 'sdJunk', type: 2, _category:'Other', _min_build_tool_level: 46, _min_workbench_level: 31 });
		sdShop.options.push({ _class: 'sdCube', kind:3, _category:'Other', _min_build_tool_level: 60, _min_workbench_level: 31 });
		sdShop.options.push({ _class: 'sdCube', kind:4, _category:'Other', _min_build_tool_level: 59, _min_workbench_level: 31 });
		sdShop.options.push({ _class: 'sdCube', kind:5, _category:'Other', _min_build_tool_level: 58, _min_workbench_level: 30 });
		sdShop.options.push({ _class: 'sdWater', type: sdWater.TYPE_TOXIC_GAS, _category:'Other', _min_build_tool_level: 45, _min_workbench_level: 24 });
		...
		sdShop.options.push({ _class: 'sdBarrel', color: '#ff6633', filter: 'hue-rotate(220deg) saturate(20)', variation: 2, _category:'Equipment', _min_build_tool_level:5, _min_workbench_level: 1 });
		sdShop.options.push({ _class: 'sdBarrel', color: '#ff0000', filter: 'hue-rotate(300deg) saturate(20)', variation: 2.5, _category:'Equipment', _min_build_tool_level:7, _min_workbench_level: 1 });
		...
		sdShop.options.push({ _class: 'sdBarrel', color: '#777777', filter: 'saturate(0) brightness(0.75)', variation: 3.25, _category:'Equipment', _min_build_tool_level:11, _min_workbench_level: 26 });
		sdShop.options.push({ _class: 'sdBarrel', color: '#333333', filter: 'saturate(0) brightness(0.5)', variation: 3.5, _category:'Equipment', _min_build_tool_level:14, _min_workbench_level: 26 });
		sdShop.options.push({ _class: 'sdBarrel', color: '#000000', filter: 'saturate(0) brightness(0.25)', variation: 4, _category:'Equipment', _min_build_tool_level:17, _min_workbench_level: 26 });
		...
		sdShop.upgrades = {
			upgrade_suit:
			{
				...
				{
					character.hmax = character.hmax + 100;
					if ( character.s >= 111 )
					character.s = character.s + 1;
				}
			},
			upgrade_damage:
			{
				...
				action: ( character, level_purchased )=>
				{
					character._damage_mult = character._damage_mult + 0.2;
				}
			},
			/*upgrade_build_hp:
			{
				...
				action: ( character, level_purchased )=>
				{
					character._build_hp_mult = character._build_hp_mult + 0.2;
				}
			},*/
			upgrade_energy:
			{
				...
				action: ( character, level_purchased )=>
				{
					character.matter_max = character.matter_max + 45; // Max is 1850
					character._energy_upgrade = character._energy_upgrade + 45;
				}
			},
			upgrade_hook:
			{
			...
			upgrade_recoil_reduction: // Upgrade idea & pull request by Booraz149 ( https://github.com/Booraz149 )
			{
				...
				action: ( character, level_purchased )=>
				{
					character._recoil_mult = character._recoil_mult - 0.04 ; // Small recoil reduction, don't want rifles turn to laser beams
				}
			},
			upgrade_oxygen_capacity: // Upgrade idea & pull request by Booraz149 ( https://github.com/Booraz149 )
			{
				...
				action: ( character, level_purchased )=>
				{
					character._air_upgrade = character._air_upgrade + 1 ;
				}
			},
			...
			upgrade_grenades:
			{
				...
				description: 'Your suit will be able to throw grenades by pressing G on demand, each will cost 150 matter.',
				action: ( character, level_purchased )=>
				{
				}
			},
			upgrade_stability_fullup:
			{
				max_level: 5,
				matter_cost: 450,
				min_build_tool_level: 15,
				min_workbench_level: 27,
				description: 'Stand up faster than before, better than normal.',
				action: ( character, level_purchased )=>
				{
					character.stability_upgrade = 4 + character.stability_upgrade;
				}
			},
			upgrade_speedup:
			{
				...
				min_workbench_level: 7,
				description: 'Run like Sonic, don\'t slow down, keep your speed faster and faster.',
				action: ( character, level_purchased )=>
				{
					character.speed_up = true;
				}
			},
			upgrade_workbench:
			{
				...
				action: ( character, level_purchased )=>
				{
					character.workbench_level = character.workbench_level + 1;
				}
			},
			upgrade_fasterfist:
			{
				...
				description: 'Don\'t you like the purple guy or Monkey D?',
				action: ( character, level_purchased )=>
				{
					character.faster_fist = true;
				}
			},
			upgrade_ironfist:
			{
				max_level: 1,
				matter_cost: 1000,
				min_build_tool_level: 29,
				min_workbench_level: 24,
				description: 'This is the power with you could hit everything, expect hit yourself.',
				action: ( character, level_purchased )=>
				{
					character.iron_fist = true;
				}
			}
		};
		for ( var i in sdShop.upgrades )
		{
			...
			sdShop.options.push({ _class: null, matter_cost: sdShop.upgrades[ i ].matter_cost, upgrade_name: i, description: sdShop.upgrades[ i ].description, 
				_category:'Upgrades', _min_build_tool_level: sdShop.upgrades[ i ].min_build_tool_level || 0, _min_workbench_level: sdShop.upgrades[ i ].min_workbench_level || 0 });
		}
		...
		//if ( globalThis.isWin ) // Lack of this check will probably allow creation of these entities even if category can not be opened in normal way
		{
			...
			sdShop.options.push({ _class: 'sdHoverBike', filter: 'saturate(0) brightness(1.5)', _category:'Development tests' });
			sdShop.options.push({ _class: 'sdHoverBike', filter: 'saturate(0) brightness(0.5)', _category:'Development tests' });
		...
		sdShop.options.push({ _class: 'sdGun', class:sdGun.CLASS_ADMIN_HEAL, _category:'Admin tools' });
		sdShop.options.push({ _class: 'sdGun', class:sdGun.CLASS_ADMIN_LOST, _category:'Admin tools' });
		sdShop.options.push({ _class: 'sdGun', class:sdGun.CLASS_ADMIN_LOST2, _category:'Admin tools' });
		sdShop.options.push({ _class: 'sdGun', class:sdGun.CLASS_ADMIN_EMPTY, _category:'Admin tools' });
		sdShop.options.push({ _class: 'sdGun', class:sdGun.CLASS_ADMIN_EMPTY2, _category:'Admin tools' });
		sdShop.options.push({ _class: 'sdGun', class:sdGun.CLASS_ADMIN_CRYSTAL, _category:'Admin tools' });
		sdShop.options.push({ _class: 'sdGun', class:sdGun.CLASS_ADMIN_GOD, _category:'Admin tools' });
		sdShop.options.push({ _class: 'sdLongRangeTeleport', is_server_teleport:1, _category:'Admin tools' });
		sdShop.options.push({ _class: 'sdTurret', kind:sdTurret.KIND_LASER, _category:'Admin tools', type: 1 });
		sdShop.options.push({ _class: 'sdTurret', kind:sdTurret.KIND_ROCKET, _category:'Admin tools', type: 1 });
		sdShop.options.push({ _class: 'sdTurret', kind:sdTurret.KIND_RAPID_LASER, _category:'Admin tools', type: 1 });
		sdShop.options.push({ _class: 'sdTurret', kind:sdTurret.KIND_SNIPER, _category:'Admin tools', type: 1 });
		sdShop.options.push({ _class: 'sdTurret', kind:sdTurret.KIND_FREEZER, _category:'Admin tools', type: 1 });
		sdShop.options.push({ _class: 'sdCrystal', type: sdCrystal.TYPE_CRYSTAL_ARTIFICIAL, tag: 'deep', matter_max: 5120 * 8, _category:'Admin tools' });
		sdShop.options.push({ _class: 'sdCrystal', tag: 'deep', matter_max: 5120 * 8, _category:'Admin tools' });
		sdShop.options.push({ _class: 'sdCrystal', type: sdCrystal.TYPE_CRYSTAL_CORRUPTED, tag: 'deep', matter_max: 5120 * 8, _category:'Admin tools' });
		sdShop.options.push({ _class: 'sdCrystal', type: sdCrystal.TYPE_CRYSTAL_BIG, tag: 'deep', matter_max: 5120 * 32, _category:'Admin tools' });
		sdShop.options.push({ _class: 'sdCrystal', type: sdCrystal.TYPE_CRYSTAL_CRAB, tag: 'deep', matter_max: 5120 * 8, _category:'Admin tools' });
		sdShop.options.push({ _class: 'sdCrystal', type: sdCrystal.TYPE_CRYSTAL_CRAB_BIG, tag: 'deep', matter_max: 5120 * 32, _category:'Admin tools' });
		sdShop.options.push({ _class: 'sdCrystal', type: sdCrystal.TYPE_CRYSTAL_GIANT, tag: 'deep', matter_max: 5120 * 128, _category:'Admin tools' });
		...
		sdShop.options.push({ _class: 'sdCrystal', type: sdCrystal.TYPE_CRYSTAL_BIG, tag: 'deep', matter_max: sdCrystal.anticrystal_value * 4, _category:'Admin tools' });
		sdShop.options.push({ _class: 'sdCrystal', type: sdCrystal.TYPE_CRYSTAL_CRAB, tag: 'deep', matter_max: sdCrystal.anticrystal_value, _category:'Admin tools' });
		sdShop.options.push({ _class: 'sdCrystal', type: sdCrystal.TYPE_CRYSTAL_CRAB_BIG, tag: 'deep', matter_max: sdCrystal.anticrystal_value * 4, _category:'Admin tools' });
		sdShop.options.push({ _class: 'sdObelisk', _category:'Admin tools' });
		sdShop.options.push({ _class: 'sdObelisk', type: 2, _category:'Admin tools' });
		sdShop.options.push({ _class: 'sdObelisk', type: 3, _category:'Admin tools' });
		sdShop.options.push({ _class: 'sdObelisk', type: 4, _category:'Admin tools' });
		sdShop.options.push({ _class: 'sdObelisk', type: 5, _category:'Admin tools' });
		sdShop.options.push({ _class: 'sdObelisk', type: 6, _category:'Admin tools' });
		sdShop.options.push({ _class: 'sdObelisk', type: 7, _category:'Admin tools' });
		sdShop.options.push({ _class: 'sdObelisk', type: 8, _category:'Admin tools' });
		sdShop.options.push({ _class: 'sdFactionSpawner', type: 10, _category:'Admin tools' });
		sdShop.options.push({ _class: 'sdFactionSpawner', type: 1, _category:'Admin tools' });
		sdShop.options.push({ _class: 'sdFactionSpawner', type: 2, _category:'Admin tools' });
		sdShop.options.push({ _class: 'sdFactionSpawner', type: 4, _category:'Admin tools' });
		sdShop.options.push({ _class: 'sdFactionSpawner', type: 5, _category:'Admin tools' });
		sdShop.options.push({ _class: 'sdFactionSpawner', type: 7, _category:'Admin tools' });
		sdShop.options.push({ _class: 'sdFactionSpawner', type: 8, _category:'Admin tools' });
		sdShop.options.push({ _class: 'sdFactionSpawner', type: 9, _category:'Admin tools' });
		...
		ctx.save();
		{
			...
			for ( var i = 0; i < sdShop.options.length; i++ )
			{
					 ...
					 ( sdShop.options[ i ]._category.charAt( 0 ) === '!' && sdShop.options[ i ]._category.substring( 1 ) !== sdShop.current_category ) ) // !root case
				{
					...
					if ( ( sdShop.options[ i ]._min_workbench_level || 0 ) > ( sdWorld.my_entity.GetWorkBenchLevel() || sdWorld.my_entity.workbench_level ) )
					continue;
