...
class sdShop
{
	static init_class()
	{
		...
		for ( var i = 0; i < 20; i++ )
		{
			...
			sdShop.options.push({ _class: 'sdDoor', width: 32, height: 32, filter: filter, _category:'Doors', open_type: 1, _min_workbench_level: 9 });
			sdShop.options.push({ _class: 'sdDoor', width: 32, height: 32, filter: filter, model: sdDoor.MODEL_ARMORED, _reinforced_level: 1, _category:'Doors', _min_build_tool_level: 7, open_type: 1, _min_workbench_level: 11 });
			sdShop.options.push({ _class: 'sdDoor', width: 32, height: 32, filter: filter, model: sdDoor.MODEL_ARMORED_LVL2, _reinforced_level: 2, _category:'Doors', _min_build_tool_level: 16, open_type: 1, _min_workbench_level: 12 });
		}
		...
		sdShop.options.push({ _class: 'sdCom', variation: 10, _category:'Base equipment', _min_build_tool_level:20, _min_workbench_level: 3 });
		sdShop.options.push({ _class: 'sdCom', variation: 11, _category:'Base equipment', _min_build_tool_level:22, _min_workbench_level: 4 });
		...
		sdShop.options.push({ _class: 'sdStorage', filter: 'hue-rotate(205deg) saturate(20)', _category:'Base equipment', _min_workbench_level: 1 });
		sdShop.options.push({ _class: 'sdStorage', filter: 'hue-rotate(220deg) saturate(10)', _category:'Base equipment', _min_workbench_level: 1 });
		sdShop.options.push({ _class: 'sdStorage', filter: 'hue-rotate(135deg) saturate(10)', _category:'Base equipment', _min_workbench_level: 1 });
		...
		sdShop.options.push({ _class: 'sdStorage', type: 1, filter: 'hue-rotate(205deg) saturate(20)', _category:'Base equipment', _min_build_tool_level: 1, _min_workbench_level: 1 });
		sdShop.options.push({ _class: 'sdStorage', type: 1, filter: 'hue-rotate(220deg) saturate(10)', _category:'Base equipment', _min_build_tool_level: 1, _min_workbench_level: 1 });
		sdShop.options.push({ _class: 'sdStorage', type: 1, filter: 'hue-rotate(135deg) saturate(10)', _category:'Base equipment', _min_build_tool_level: 1, _min_workbench_level: 1 });
		...
		sdShop.options.push({ _class: 'sdStorage', type: 2, filter: 'hue-rotate(205deg) saturate(20)', _category:'Base equipment', _min_workbench_level: 1 });
		sdShop.options.push({ _class: 'sdStorage', type: 2, filter: 'hue-rotate(220deg) saturate(10)', _category:'Base equipment', _min_workbench_level: 1 });
		sdShop.options.push({ _class: 'sdStorage', type: 2, filter: 'hue-rotate(135deg) saturate(10)', _category:'Base equipment', _min_workbench_level: 1 });
		...
		sdShop.options.push({ _class: 'sdStorage', type: 3, filter: 'hue-rotate(205deg) saturate(20)', _category:'Base equipment', _min_build_tool_level: 2, _min_workbench_level: 2 });
		sdShop.options.push({ _class: 'sdStorage', type: 3, filter: 'hue-rotate(220deg) saturate(10)', _category:'Base equipment', _min_build_tool_level: 2, _min_workbench_level: 2 });
		sdShop.options.push({ _class: 'sdStorage', type: 3, filter: 'hue-rotate(135deg) saturate(10)', _category:'Base equipment', _min_build_tool_level: 2, _min_workbench_level: 2 });
		...
		sdShop.options.push({ _class: 'sdTurret', kind:sdTurret.KIND_LASER, _category:'Base equipment', type: 1, _min_build_tool_level: 10, _min_workbench_level: 10 });
		sdShop.options.push({ _class: 'sdTurret', kind:sdTurret.KIND_ROCKET, _category:'Base equipment', type: 1, _min_build_tool_level: 10, _min_workbench_level: 12 });
		sdShop.options.push({ _class: 'sdTurret', kind:sdTurret.KIND_RAPID_LASER, _category:'Base equipment', type: 1, _min_build_tool_level: 14, _min_workbench_level: 14 });
		sdShop.options.push({ _class: 'sdTurret', kind:sdTurret.KIND_SNIPER, _category:'Base equipment', type: 1, _min_build_tool_level: 28, _min_workbench_level: 16 });
		sdShop.options.push({ _class: 'sdTurret', kind:sdTurret.KIND_FREEZER, _category:'Base equipment', type: 1, _min_build_tool_level: 30, _min_workbench_level: 18 });
		...
		sdShop.options.push({ _class: 'sdMatterContainer', matter_max:640 * 4 * 2 * 2, _category:'Base equipment', _min_build_tool_level: 6, _min_workbench_level: 14 });
		sdShop.options.push({ _class: 'sdMatterContainer', matter_max:640 * 8 * 2 * 2, _category:'Base equipment', _min_build_tool_level: 9, _min_workbench_level: 17 });
		sdShop.options.push({ _class: 'sdMatterContainer', matter_max:640 * 8 * 4 * 2, _category:'Base equipment', _min_build_tool_level: 12, _min_workbench_level: 20 });
		...
		sdShop.options.push({ _class: 'sdUpgradeStation', _category:'Base equipment', _min_build_tool_level: 3, _min_workbench_level: 21 });
		...
		sdShop.options.push({ _class: 'sdWorkbench', type: 3, _category:'Base equipment', _min_build_tool_level: 30, _min_workbench_level: 14 });
		...
		sdShop.options.push({ _class: 'sdFactionSpawner', type: 10, _category:'Base equipment', _min_build_tool_level: 22, _min_workbench_level: 19 });
		sdShop.options.push({ _class: 'sdFactionSpawner', type: 9, _category:'Base equipment', _min_build_tool_level: 30, _min_workbench_level: 21 });
		sdShop.options.push({ _class: 'sdCrystal', matter_max: 40, type:sdCrystal.TYPE_CRYSTAL_ARTIFICIAL, _category:'Other', _min_build_tool_level: 1, _min_workbench_level: 6 });
		sdShop.options.push({ _class: 'sdCrystal', matter_max: 80, type:sdCrystal.TYPE_CRYSTAL_ARTIFICIAL, _category:'Other', _min_build_tool_level: 3, _min_workbench_level: 8 });
		sdShop.options.push({ _class: 'sdCrystal', matter_max: 160, type:sdCrystal.TYPE_CRYSTAL_ARTIFICIAL, _category:'Other', _min_build_tool_level: 5, _min_workbench_level: 10 });
		sdShop.options.push({ _class: 'sdCrystal', matter_max: 320, type:sdCrystal.TYPE_CRYSTAL_ARTIFICIAL, _category:'Other', _min_build_tool_level: 10, _min_workbench_level: 12 });
		sdShop.options.push({ _class: 'sdCrystal', matter_max: 640, type:sdCrystal.TYPE_CRYSTAL_ARTIFICIAL, _category:'Other', _min_build_tool_level: 15, _min_workbench_level: 14 });
		sdShop.options.push({ _class: 'sdCrystal', matter_max: 1280, type:sdCrystal.TYPE_CRYSTAL_ARTIFICIAL, _category:'Other', _min_build_tool_level: 20, _min_workbench_level: 16 });
		sdShop.options.push({ _class: 'sdCrystal', matter_max: 2560, type:sdCrystal.TYPE_CRYSTAL_ARTIFICIAL, _category:'Other', _min_build_tool_level: 25, _min_workbench_level: 18 });
		sdShop.options.push({ _class: 'sdCrystal', matter_max: 5120, type:sdCrystal.TYPE_CRYSTAL_ARTIFICIAL, _category:'Other', _min_build_tool_level: 30, _min_workbench_level: 20 });
		sdShop.options.push({ _class: 'sdCrystal', matter_max: 5120 * 2, type:sdCrystal.TYPE_CRYSTAL_ARTIFICIAL, _category:'Other', _min_build_tool_level: 30, _min_workbench_level: 21 });
		sdShop.options.push({ _class: 'sdJunk', type: 0, _category:'Other', _min_build_tool_level: 4, _min_workbench_level: 15 });
		sdShop.options.push({ _class: 'sdJunk', type: 1, _category:'Other', _min_build_tool_level: 6, _min_workbench_level: 17 });
		sdShop.options.push({ _class: 'sdJunk', type: 7, _category:'Other', _min_build_tool_level: 8, _min_workbench_level: 19 });
		sdShop.options.push({ _class: 'sdJunk', type: 2, _category:'Other', _min_build_tool_level: 6, _min_workbench_level: 21 });
		sdShop.options.push({ _class: 'sdCube', kind:3, _category:'Other', _min_build_tool_level: 30, _min_workbench_level: 21 });
		sdShop.options.push({ _class: 'sdCube', kind:4, _category:'Other', _min_build_tool_level: 29, _min_workbench_level: 21 });
		sdShop.options.push({ _class: 'sdCube', kind:5, _category:'Other', _min_build_tool_level: 28, _min_workbench_level: 20 });
		...
		sdShop.options.push({ _class: 'sdBarrel', color: '#777777', filter: 'saturate(0) brightness(0.75)', variation: 3.25, _category:'Equipment', _min_build_tool_level:11, _min_workbench_level: 2 });
		sdShop.options.push({ _class: 'sdBarrel', color: '#333333', filter: 'saturate(0) brightness(0.5)', variation: 3.5, _category:'Equipment', _min_build_tool_level:14, _min_workbench_level: 3 });
		sdShop.options.push({ _class: 'sdBarrel', color: '#000000', filter: 'saturate(0) brightness(0.25)', variation: 4, _category:'Equipment', _min_build_tool_level:17, _min_workbench_level: 5 });
		...
		sdShop.upgrades = {
			...
			upgrade_workbench:
			{
				...
				description: 'Easy to build some of the tools without workbench, not for 14 levels.',
				action: ( character, level_purchased )=>
				{
