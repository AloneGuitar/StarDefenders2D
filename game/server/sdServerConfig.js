...
class sdServerConfigShort
{
	...
	static only_admins_can_spectate = false;
...
class sdServerConfigFull extends sdServerConfigShort
{
	...
	{
		return 30 * 60 * 4; // Return max possible time until next event rolls
	}
